...
public class AyarlarActivty extends AppCompatActivity {

    /*Burada ayarlar activity içinde sadece menu olusturma kodları var
    ve şimdi bunlarıdiğer activityler için kalıtı ile alacağız.
     */
